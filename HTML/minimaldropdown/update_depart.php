...
<body>
    ...
    //echo $user_id;
    $query = "SELECT * FROM department_info WHERE department_id=$department_id";
    ...
    <p>&nbsp&nbsp<span class="material-icons">edit_note</span>แก้ไขฝ่ายงาน</p>
    <form action="updatedepart_db.php" method="post">
        ...
        <div class="grid-container">
            ...
            <div class="row">
                    ...
                    <div class="col-75">
                        ...
                        required value="<?php echo $row['department_id'];?>" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                        <label for="fname"> ชื่อฝ่ายงาน:</label>
                    </div>
                    <div class="col-75">
                        <input type="text" name="departname" 
                        required value="<?php echo $row['department_name'];?>">
                    </div>
                </div>
            ...
            <div class="container-button">
                <button type="reset" value="reset" class="backButton" onclick="parent.location='edit_depart.php'">Back </button>
                <button type="submit" name="Update_depart" class="summitButton">Submit</button>
            </div>
        </div>
    </form>
</body>
