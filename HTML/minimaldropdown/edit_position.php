...
<body>
    ...
    <table border="5" widht="100%" align="center">
        <caption><a href="add_position.php" class="adddetail"><span
        ...
        $sql= "SELECT * FROM `perposition_info` WHERE perposition_name LIKE '%$search%'";
        ...
        ?>
            ...
            <tr class="prodetail">
                ...
                <td>
                    <a href="update_position.php?id=<?php echo $row['perposition_id']; ?>"><span
                            class="material-icons">edit</span>Edit</a>
                </td>
                <td>
                    <a href="delete_position.php?id=<?php echo $row[
                        'perposition_id']; ?>" onclick="return confirm('ยืนยันการลบข้อมูล');"><span
