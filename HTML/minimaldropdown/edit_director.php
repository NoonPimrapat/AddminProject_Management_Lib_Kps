<?php
    ...
    include('../config/db.php'); 
        $query = "SELECT * FROM `director_info`"; 
...
<body>
    ...
    <div class="prodetail">
        <table border="5" widht="100%" align="center">
            <caption><a href="add_director.php" class="adddetail"> <span
                        class="material-icons">person_add</span>เพิ่มผู้อำนวยการ</a></caption>
            <thead>
                <tr class="prodetail">
    ...
    <tbody>
        ...
        <tr class="prodetail">
            ...
            <td> <?php echo $row['director_lastname']; ?></td>

            <td><a href="update_director.php?id=<?php echo $row['director_id']; ?>"><span
                        class="material-icons">edit</span>Edit</a>
            </td>
            <td>
                <a href="delete_director.php?id=<?php echo $row[
                        'director_id']; ?>" onclick="return confirm('ยืนยันการลบข้อมูล');"><span
