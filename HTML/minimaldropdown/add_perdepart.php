...
<body>
    ...
    <p>&nbsp&nbsp<span class="material-icons">add_circle</span>เพิ่มแผนกบุคลากร</p>
    <form action="addperdepart_db.php" method="post">
        ...
        <div class="grid-container">
            <div class="grid-item">
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="text" name="perdepartname" required>
                    </div>
                </div>
                
            <div class="container-button">
                <button type="reset" value="reset" class="backButton">ล้าง </button>
                <button type="submit" name="Add_perdepart" class="summitButton">เพิ่ม</button>
            </div>
        </div>
    </form>
</body>
