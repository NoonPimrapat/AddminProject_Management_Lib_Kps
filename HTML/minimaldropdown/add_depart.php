...
<body>
    ...
    <p>&nbsp&nbsp<span class="material-icons">add_circle</span>เพิ่มฝ่ายงาน</p>
    <form action="adddepart_db.php" method="post">
        ...
        <div class="grid-container">
            ...
            <div class="container-button">
                ...
                <button type="submit" name="Add_depart" class="summitButton">เพิ่ม</button>
            </div>
        </div>
    </form>
</body>
