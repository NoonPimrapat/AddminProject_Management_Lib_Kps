...
<body>
    ...
    <p>&nbsp&nbsp<span class="material-icons">add_circle</span>เพิ่มตำแหน่งบุคลากร</p>
    <form action="addposition_db.php" method="post">
        ...
        <div class="grid-container">
            ...
            <div class="container-button">
                ...
                <button type="submit" name="Add_position" class="summitButton">เพิ่ม</button>
            </div>
        </div>
    </form>
</body>
