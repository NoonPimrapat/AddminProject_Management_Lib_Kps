...
<body>
    ...
    $director_id = $_GET['id'];
    //echo $user_id;
    $query = "SELECT * FROM director_info WHERE director_id=$director_id";
    ...
    <p>&nbsp&nbsp<span class="material-icons">edit_note</span>แก้ไขผู้อำนวยการ</p>
    <form action="updatedirector_db.php" method="post">
        ...
        <div class="grid-container">
            ...
            <div class="row">
                    ...
                    <div class="col-75">
                        ...
                        required value="<?php echo $row['director_id'];?>" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        ...
                        required value="<?php echo $row['director_name'];?>"></br></br>
                        <input type="text" name="directorlastname" 
                        required value="<?php echo $row['director_lastname'];?>">
                    </div>
                </div>
            ...
            <div class="container-button">
                <button type="reset" value="reset" class="backButton" onclick="parent.location='edit_director.php'">Back </button>
                <button type="submit" name="Update_director" class="summitButton">Submit</button>
            </div>
        </div>
    </form>
</body>
