...
<body>
    ...
    <table border="5" widht="100%" align="center">
        <caption><a href="add_perdepart.php" class="adddetail"><span
        ...
        $sql= "SELECT * FROM `perdepartment_info` WHERE perdepartment_name  LIKE '%$search%'";
        ...
        ?>
            ...
            <tr class="prodetail">
                ...
                <td>
                    <a href="update_perdepart.php?id=<?php echo $row['perdepartment_id']; ?>"><span
                            class="material-icons">edit</span>Edit</a>
                </td>
                <td>
                    <a href="delete_perdepart.php?id=<?php echo $row[
                        'perdepartment_id']; ?>" onclick="return confirm('ยืนยันการลบข้อมูล');"><span
