...
<body>
    ...
    include('../config/db.php');
    // ไอดีที่ส่งมาแก้ไข 
    $project_style_id = $_GET['id'];
    //echo $user_id;
    $query = "SELECT * FROM project_style_info WHERE project_style_id=$project_style_id";
    ...
    <p>&nbsp&nbsp<span class="material-icons">edit_note</span>แก้ไขลักษณะโครงการ</p>
    <form action="updatecharact_db.php" method="post">
        ...
        <div class="grid-container">
            <div class="grid-item">
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="text" name="id" required value="<?php echo $row['project_style_id'];?>" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                        <label for="fname"> ชื่อลักษณะโครงการ:</label>
                    </div>
                    <div class="col-75">
                        <input type="text" name="charactname" required value="<?php echo $row['project_style_name'];?>">
                    </div>
                </div>
                ...
                <div class="container-button">
                    <button type="reset" value="reset" class="backButton"
                        onclick="parent.location='edit_charact.php'">Back </button>
                    <button type="submit" name="Update_charact" class="summitButton">Submit</button>
                </div>
            </div>
    </form>
</body>
