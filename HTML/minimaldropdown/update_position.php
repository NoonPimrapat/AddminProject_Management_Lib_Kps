...
<body>
    ...
    include('../config/db.php');
    // ไอดีที่ส่งมาแก้ไข 
    $perposition_id = $_GET['id'];
    //echo $user_id;
    $query = "SELECT * FROM perposition_info WHERE perposition_id=$perposition_id";
    ...
    <p>&nbsp&nbsp<span class="material-icons">edit_note</span>แก้ไขตำแหน่งบุคลากร</p>
    <form action="updateposition_db.php" method="post">
        ...
        <div class="grid-container">
            ...
            <div class="row">
                    ...
                    <div class="col-75">
                        ...
                        required value="<?php echo $row['perposition_id'];?>" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                        <label for="fname"> ชื่อตำแหน่งบุคลากร:</label>
                    </div>
                    <div class="col-75">
                        <input type="text" name="positionname" 
                        required value="<?php echo $row['perposition_name'];?>">
                    </div>
                </div>
            ...
            <div class="container-button">
                <button type="reset" value="reset" class="backButton" onclick="parent.location='edit_position.php'">Back </button>
                <button type="submit" name="Update_position" class="summitButton">Submit</button>
            </div>
        </div>
    </form>
</body>
