...
<body>
        ...
        <div class="wrapper">
            <div class="navbar">
                ...
                <div class="navbar_right">
                    <div class="profile">
                        <div class="icon_wrap">
                            <img id="output" src=" <?php echo $value['user_pic'];?>" class="show-profile-mini" />
    ...
    <div class="bar">
        ...
        <p class="titleBar">จัดการบุคคลากร/</p><span class="material-icons">person_remove</span>
        <p class="titleBar">แก้ไขและลบบุคลากร</p>
    </div>

    <form method="get" id="form" enctype="multipart/form-data" action="">
        <strong>&nbspค้นหาข้อมูลชื่อ<span class="material-icons">person_search</span></strong>
    ...
    <table>
        ...
        ?>
            ...
            <tr class="edittable">
                ...
                <td> <img id="output" width="300" height="300" src="<?php echo $row['user_pic']; ?>"
                        class="show-profile-mini" />
                </td>
                <td>
                    <a href="member_edit.php?id=<?php echo $row['user_id']; ?>"><span
                            class="material-icons">edit</span>Edit</a>
                </td>
                <td>
                    <a href="member_delete.php?id=<?php echo $row[
                        'user_id']; ?>" onclick="return confirm('ยืนยันการลบข้อมูล');"><span
